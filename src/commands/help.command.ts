...
const HELP_TOPICS: HelpTopic[] = [
  {
    id: "gotm",
    label: "/gotm",
    summary: "Search Game of the Month (GOTM) data.",
    syntax: "Syntax: /gotm [round:<integer>] [year:<integer>] [month:<string>] [title:<string>]",
    notes:
      "If round is provided, it takes precedence. year+month target a specific month. title searches by game title.",
  },
  {
    id: "nr-gotm",
    label: "/nr-gotm",
    summary: "Search Non-RPG Game of the Month (NR-GOTM) data.",
    syntax:
  ...
  },
  {
    id: "round",
    label: "/round",
    summary: "Show the current voting round, including GOTM and NR-GOTM winners.",
    syntax: "Syntax: /round",
  },
  {
    id: "nextvote",
    label: "/nextvote",
    summary: "Show the date of the next GOTM/NR-GOTM vote and the discussion channels.",
    syntax: "Syntax: /nextvote",
  },
  {
    id: "hltb",
    label: "/hltb",
    summary: "Search HowLongToBeat for game completion times.",
    syntax: "Syntax: /hltb title:<string>",
    parameters: "title (required string) - game title and optional descriptors.",
  },
  {
    id: "coverart",
    label: "/coverart",
    summary: "Search for video game cover art using Google/HLTB data.",
    syntax: "Syntax: /coverart title:<string>",
    parameters: "title (required string) - game title and optional descriptors.",
  },
  {
    id: "admin",
