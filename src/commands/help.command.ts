...
const GAME_COMPLETION_HELP_TOPICS: GameCompletionHelpTopic[] = [
  {
    ...
    syntax:
      "Syntax: /game-completion add [game_id:<int> | title:<string>] completion_type:<choice> [completion_date:<date>] [final_playtime_hours:<number>] [note:<string>] [announce:<boolean>]",
    notes:
  ...
  },
  {
    ...
    syntax:
      "Syntax: /game-completion list [year:<int>] [title:<string>] [member:<user>] [all:<boolean>] [showinchat:<bool>]",
    notes:
