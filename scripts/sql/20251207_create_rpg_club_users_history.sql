...
CREATE INDEX IDX_RPG_CLUB_USERS_HIST_USER ON RPG_CLUB_USERS_HIST (USER_ID);
...
BEGIN
  IF INSERTING THEN
    INSERT INTO RPG_CLUB_USERS_HIST (
      ...
      STEAM_URL, PROFILE_IMAGE, PROFILE_IMAGE_AT, CREATED_AT, UPDATED_AT,
      ACTION_TYPE
    ) VALUES (
      ...
      :NEW.STEAM_URL, :NEW.PROFILE_IMAGE, :NEW.PROFILE_IMAGE_AT, :NEW.CREATED_AT, :NEW.UPDATED_AT,
      'I'
    );
  ELSIF UPDATING THEN
    INSERT INTO RPG_CLUB_USERS_HIST (
      ...
      :OLD.STEAM_URL, :OLD.PROFILE_IMAGE, :OLD.PROFILE_IMAGE_AT, :OLD.CREATED_AT, :OLD.UPDATED_AT,
      'U'
    );
  ELSIF DELETING THEN
    INSERT INTO RPG_CLUB_USERS_HIST (
