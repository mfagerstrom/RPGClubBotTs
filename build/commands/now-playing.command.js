...
let NowPlayingCompletionCommands = class NowPlayingCompletionCommands {
    ...
    async renderCompletionPage(interaction, userId, page, year, ephemeral) {
        ...
        // Let's use dynamic.
        const maxIndexLabelLength = String(Math.max(...pageCompletions.map((c) => yearIndices.get(c.completionId) ?? 0))).length + 1; // +1 for dot
...
], NowPlayingCompletionCommands.prototype, "completionAdd", null);
__decorate([
...
], NowPlayingCompletionCommands.prototype, "completionList", null);
__decorate([
    Slash({ description: "Edit one of your completion records", name: "edit" })
], NowPlayingCompletionCommands.prototype, "completionEdit", null);
__decorate([
    Slash({ description: "Delete one of your completion records", name: "delete" })
], NowPlayingCompletionCommands.prototype, "completionDelete", null);
__decorate([
    SelectMenuComponent({ id: /^completion-add-select:.+/ })
], NowPlayingCompletionCommands.prototype, "handleCompletionAddSelect", null);
__decorate([
    ButtonComponent({ id: /^comp-del:[^:]+:\d+$/ })
], NowPlayingCompletionCommands.prototype, "handleCompletionDeleteButton", null);
__decorate([
    ButtonComponent({ id: /^comp-edit:[^:]+:\d+$/ })
], NowPlayingCompletionCommands.prototype, "handleCompletionEditSelect", null);
__decorate([
    ButtonComponent({ id: /^comp-edit-field:[^:]+:\d+:(type|date|playtime)$/ })
], NowPlayingCompletionCommands.prototype, "handleCompletionFieldEdit", null);
__decorate([
    ButtonComponent({ id: /^comp-list-page:[^:]+:[^:]*:\d+:(prev|next)$/ })
], NowPlayingCompletionCommands.prototype, "handleCompletionListPaging", null);
NowPlayingCompletionCommands = __decorate([
    Discord(),
    SlashGroup({ name: "completion", description: "Manage game completions", root: "now-playing" }),
    SlashGroup("completion", "now-playing")
], NowPlayingCompletionCommands);
export { NowPlayingCompletionCommands };
