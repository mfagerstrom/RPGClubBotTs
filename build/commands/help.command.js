...
const PROFILE_HELP_TOPICS = [
    ...
    },
    {
        ...
        syntax: "Syntax: /profile completion-add [game_id:<int> | query:<string> | from_now_playing:<bool>] completion_type:<choice> [completion_date:<date>] [final_playtime_hours:<number>]",
    ...
    },
    {
        ...
        syntax: "Syntax: /profile completion-edit completion_id:<int> [completion_type:<choice>] [completion_date:<date>] [final_playtime_hours:<number>]",
