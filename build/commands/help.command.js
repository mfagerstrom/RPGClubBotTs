...
const GAME_COMPLETION_HELP_TOPICS = [
    {
        ...
        syntax: "Syntax: /game-completion add [game_id:<int> | title:<string> | from_now_playing:<bool>] completion_type:<choice> [completion_date:<date>] [final_playtime_hours:<number>] [announce:<boolean>]",
