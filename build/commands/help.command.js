...
const GAME_COMPLETION_HELP_TOPICS = [
    {
        ...
        syntax: "Syntax: /game-completion add [game_id:<int> | query:<string> | from_now_playing:<bool>] completion_type:<choice> [completion_date:<date>] [final_playtime_hours:<number>] [announce:<boolean>]",
        notes: "Completion type choices: Main Story, Main Story + Side Content, Completionist. Completion date defaults to today; playtime is optional (e.g., 42.5). Uses GameDB lookup/import if you provide a query. Set announce:true to post to the completions channel.",
    },
    {
        id: "list",
