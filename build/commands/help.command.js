...
let BotHelp = class BotHelp {
    async help(interaction) {
        ...
        const embed = new EmbedBuilder()
            ...
            name: "/nr-gotm",
            value: "Search Non-RPG Game of the Month (NR-GOTM) data.\n" +
                "Syntax: /nr-gotm [round:<integer>] [year:<integer>] [month:<string>] [title:<string>]\n" +
                "Notes: If round is provided, it takes precedence. year+month target a specific month. title searches by game title.",
        }, {
            name: "/round",
            value: "Show the current voting round, including GOTM and NR-GOTM winners.\n" +
                "Syntax: /round",
        }, {
            name: "/nextvote",
            value: "Show the date of the next GOTM/NR-GOTM vote and the discussion channels.\n" +
                "Syntax: /nextvote",
        }, {
            name: "/hltb",
            ...
            value: "Admin-only commands for managing bot presence and GOTM/NR-GOTM data.\n" +
                "Use /admin help for a detailed list of admin subcommands, their syntax, and parameters.",
        }, {
            name: "/mod ... (Moderator or above)",
            value: "Moderator commands for managing bot presence and NR-GOTM data.\n" +
